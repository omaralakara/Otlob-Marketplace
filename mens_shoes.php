...
$stmt = $conn->prepare("SELECT * FROM products WHERE type=\"Men's shoes\"");
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">Men's Shoes</span>
                </nav>
            </div>
        </div>
    </div>
                            ...
                            <ul class="pagination justify-content-center">
                                ...
                                for ($page = 1; $page <= $totalPages; $page++) {
                                    ...
                                    <li class="page-item <?php if ($currentPage == $page) echo 'active'; ?>">
                                        <a class="page-link" href="mens_shoes.php?page=<?php echo $page; ?>"><?php echo $page; ?></a>
                                    </li>
                                <?php
                                }
                                ?>
