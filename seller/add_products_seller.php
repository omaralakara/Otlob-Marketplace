...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: add_products_seller.php");
    exit();
}
...
<div class="container-fluid px-xl-5">
    <div class="row">
        ...
        <div class="list-group">
                ...
                <a href="add_products_seller.php" class="list-group-item list-group-item-action active">Add Products</a>
    ...
    <div class="container-fluid mt-3">
        ...
        <form action="add_products_seller.php" method="POST" enctype="multipart/form-data">
