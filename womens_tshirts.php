...
$stmt = $conn->prepare("SELECT * FROM products WHERE type=\"Women's T-shirts\"");
...
// Now $cellphones contains the fetched results ordered by the latest added
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="womens_fashion.php" class="nav-item nav-link active">Women's Fashion</a>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">Women's Fashion</span>
                    <span class="breadcrumb-item active">Women's T-shirts</span>
                </nav>
            </div>
        </div>
    </div>
        ...
        <div class="col">
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    $totalPages = ceil(count($Fetched_Products) / $productsPerPage);
                    ...
                    if ($currentPage > 1) {
                        echo '<li class="page-item"><a class="page-link" href="new_arrivals.php?page=' . ($currentPage - 1) . '">Previous</a></li>';
                    }

                    // Display up to 2 pagination links
                    for ($page = $startPage; $page <= $endPage; $page++) {
                        echo '<li class="page-item ';
                        if ($currentPage == $page) {
                            echo 'active';
                        }
                        echo '"><a class="page-link" href="new_arrivals.php?page=' . $page . '">' . $page . '</a></li>';
                    }

                    // Display next page link if not on the last page
                    if ($currentPage < $totalPages) {
                        echo '<li class="page-item"><a class="page-link" href="womens_tshirts.php?page=' . ($currentPage + 1) . '">Next</a></li>';
                    }
                    ?>
                </ul>
            </nav>
