...
$stmt = $conn->prepare("SELECT * FROM products WHERE type=\"Kid's T-shirts\"");
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="kids_fashion.php" class="nav-item nav-link active">Kids's Fashion</a>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">Kid's Fashion Fashion</span>
                    <span class="breadcrumb-item active">Kid's T-shirts</span>
                </nav>
            </div>
        </div>
    </div>
                            ...
                            <ul class="pagination justify-content-center">
                                ...
                                for ($page = 1; $page <= $totalPages; $page++) {
                                    ...
                                    <li class="page-item <?php if ($currentPage == $page) echo 'active'; ?>">
                                        <a class="page-link" href="kids_tshirts.php?page=<?php echo $page; ?>"><?php echo $page; ?></a>
                                    </li>
                                <?php
                                }
                                ?>
